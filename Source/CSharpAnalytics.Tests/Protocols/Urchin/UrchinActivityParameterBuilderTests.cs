...
{
    [TestClass]
    public class UrchinActivityParameterBuilderTests
    {
        [TestMethod]
        ...
        [TestMethod]
        public void UrchinActivityParameterBuilder_GetParameter_For_CampaignActivity_Returns_Correct_Keys_When_IsNewVisit()
        {
        ...
        [TestMethod]
        public void UrchinActivityParameterBuilder_GetParameter_For_EventActivity_With_Two_Parameters_Returns_Correct_Utme_Value()
        {
            var activity = new EventActivity("action", "category");
        ...
        [TestMethod]
        public void UrchinActivityParameterBuilder_GetParameter_For_EventActivity_With_Three_Parameters_Returns_Correct_Utme_Value()
        {
        ...
        [TestMethod]
        public void UrchinActivityParameterBuilder_GetParameter_For_ItemActivity_Returns_Correct_Values()
        {
            var activity = new TransactionItemActivity("code", "name", 1.23m, 1);
